...
internal fun MainViewModel.startSpoofing() {
    ...
    if (state.isContinuousScanning) {
        android.widget.Toast.makeText(
            context,
            context.getString(com.suseoaa.locationspoofer.ui.R.string.disable_continuous_scan_first),
...
internal fun MainViewModel.toggleContinuousScanning() {
    ...
    if (_uiState.value.isSpoofingActive) {
        android.widget.Toast.makeText(
            context,
            context.getString(com.suseoaa.locationspoofer.ui.R.string.stop_spoofing_before_scan),
            android.widget.Toast.LENGTH_SHORT
        ).show()
        return
    }
...
internal suspend fun MainViewModel.getAllLocations(): List<com.suseoaa.locationspoofer.data.db.LocationRecord> {
