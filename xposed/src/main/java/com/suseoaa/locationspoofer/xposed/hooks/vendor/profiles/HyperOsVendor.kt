...
object HyperOsVendor : SystemHookVendor {
     ...
     * [com.suseoaa.locationspoofer.xposed.hooks.vendor.VendorRegistry] 会自动在其后接上 AOSP 基线兜底，
     * 不影响这里已验证 OK 的其它组件。
     */
     ...
     * 是跨机型通用行为，仍集中在 [com.suseoaa.locationspoofer.xposed.hooks.AntiDetectionHooker] 与
     * [com.suseoaa.locationspoofer.xposed.hooks.SystemAppOpsHooker] 中无条件执行，没有迁移到这里——
